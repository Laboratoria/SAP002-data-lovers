            ...
            <div class='card text-color card-color general-color-back'>
              <div class='card-front'>
                ...
                <div class= 'champion-info box-alignment'> 
                  <ul>                
                    <li class="color-table-info champion-info"> <img src="src/assets/img/icon-attack.png"/> Attack: ${champion.info['attack']}</h3>
                    <li class="color-table-info champion-info"> <img src="src/assets/img/icon-defense.png"/> Defense: ${champion.info['defense']}</h3>
                    <li class="color-table-info champion-info"> <img src="src/assets/img/icon-magic.png"/> Magic: ${champion.info['magic']}</h3>
                    <li class="color-table-info champion-info"> <img src="src/assets/img/icon-difficulty.png"/> Difficulty: ${champion.info['difficulty']}</h3>                
                  </ul>
                </div>
              </div>
              <div class='card-back'>
